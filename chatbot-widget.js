...
function startConversation() {
    fetch('https://chatbot-for-bijou-nurseryand-creche-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-bijou-nurseryand-creche-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzaOHjLbjzJIzOO3CbXCNN7W5on-GZDj10R87M45vn4GFst7CBrYZni7zvvv6Ltbggo/exec';
